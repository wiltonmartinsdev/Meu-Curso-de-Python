...
print(f'Foram digitados {quant_num} números, sendo {maior} o maior e {menor} o menor valor digitado, sendo {soma} a soma total entre eles e tendo como média o valor de {media:.2f}.')